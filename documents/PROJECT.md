...
| spiritboard | bannzai 考案 (札棋 https://github.com/bannzai/boardgame-fudagi のローグライク化 + 幽霊収集ホラー。IdeaMemo #222 #223) | 盤面カード戦闘のローグライク | 2D | #58 |

ジャンルの選定は既存 9 本と重ならないことと、Steam の市場調査 (ローグライク・ライフシム・レーシング・ファーミング・管理シム・サバイバルクラフトの伸び) を根拠にした。spiritboard は 2026-09-07 にユーザーの発案から追加した。
